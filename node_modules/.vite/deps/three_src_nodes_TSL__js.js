...
var uniformTexture = (value = EmptyTexture) => texture(value);
...
var uniformCubeTexture = (value = EmptyTexture2) => cubeTextureBase(value);
...
var SampleNode = class extends Node_default {
  /**
